...
const painPoints = [
  {
    ...
    description:
      'Your data lives in 10 different tools. Nothing talks to anything. Every insight requires manual exports and guesswork.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-accent-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      'Hours lost every week on repetitive tasks your team shouldn\'t be doing. Data entry, follow-ups, reporting — all by hand.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-accent-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    title: 'No Real Funnel',
    description:
      'Leads come in and fall through the cracks. No automation, no nurture sequence, no system to turn interest into revenue.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-accent-purple" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
    ...
    description:
      'Too many tools, too many subscriptions, zero strategy. You\'re paying for a stack that\'s working against you.',
  },
]
