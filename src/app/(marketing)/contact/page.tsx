...
export const metadata: Metadata = createMetadata({
  ...
  description:
    'Tell us about your project and we\'ll get back to you within 2 hours. Software, automation, marketing, sales — we build it all.',
  path: '/contact',
})
        ...
        <div className="space-y-8">
          ...
          <div className="rounded-xl bg-white/5 backdrop-blur-xl border border-white/10 p-6">
            ...
            <p className="mb-4 text-sm text-neutral-400">
              Book a 15-minute discovery call and we will tell you exactly how
              we can help.
            </p>
          ...
          <div className="flex items-start gap-3 rounded-xl bg-accent-purple/5 border border-accent-purple/20 p-5">
            ...
            <p className="text-sm text-neutral-300">
              We respond within <strong className="text-foreground">2 hours</strong> during
        ...
        {[
          {
            ...
            a: 'You\'ll hear from us within 2 hours during business hours. We\'ll review your submission and schedule a discovery call to understand your project in depth.',
          },
          {
            q: 'How much does it cost?',
            a: 'Projects start at $5K. We\'ll provide a detailed proposal after understanding your specific needs, timeline, and goals.',
          },
          {
            q: 'Do you work with small businesses?',
            a: 'Absolutely. From solopreneurs to enterprises — we scale our approach to match your stage and ambition.',
          },
        ].map((item) => (
          <div
            key={item.q}
